...
export interface ScheduleState {
  ...
  scheduleChannel: Subscription
  favoritesChannel: Subscription
...
export const scheduleReducer = (
  ...
  switch (action.type) {
    ...
    case "setFavoritesChannel": {
      return { ...state, favoritesChannel: action.subscription }
    }
    case "setScheduleChannel": {
      return { ...state, scheduleChannel: action.subscription }
    }
...
export const scheduleStore = createStore(
  scheduleReducer,
  applyMiddleware(thunk as ThunkMiddleware<ScheduleState, ScheduleAction>)
)
...
export const initScheduleChannel = (): ScheduleThunk => {
  return (dispatch, getState) => {
    ...
    dispatch({ type: "setScheduleChannel", subscription })
  }
}
